...
<body>
    <div class="announcement-container">
        ...
        <div class="announcement-content">
            ...
            <div class="announcement-date">Date: <?php echo date("F j, Y", strtotime($announcement['date'])); ?> from <?php echo date("g:i A", strtotime($announcement['time'])); ?> - <?php echo date("g:i A", strtotime($announcement['timeend'])) ; ?></div>
            <div class="announcement-text">
                @<?php echo nl2br(htmlspecialchars($announcement['place'])); ?>
            </div>
            <div class="announcement-text">
                ...
                .then(result => {
                    if (result === 'success') {
                        Swal.fire(
                            ...
                            window.location.href = './index.php?url=announcement'; // Redirect to the announcements list
                        });
                    } else {
                        Swal.fire(
                            'Error!',
