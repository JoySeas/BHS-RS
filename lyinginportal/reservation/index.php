...
.reservation-btn {
        ...
        font-family: 'Poppins', sans-serif; /* Match overall font */
...
<div class="container-fluid" style="padding: 15px 15px; background-color: white; min-height: 540px; margin-top: 15px; border-radius: 5px; border: 1px solid #dcdcdc;">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="mb-0 headerfontfont" style="color: #2c2b2e; font-weight: 800; font-size: 25px;">
...
<div class="container-fluid" style="padding: 15px 15px; background-color: white; min-height: 540px; margin-top: 15px; border-radius: 5px; border: 1px solid #dcdcdc;">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <!-- <h3 class="mb-0 headerfontfont" style="color: #2c2b2e; font-weight: 500;">Reservation</h3> -->
                ...
                <table data-height="350" class="table fixTable table-hover" style="margin-bottom: 0px; border-bottom: 2px solid #000;">
                    <thead class="bg-success text-white">
                        <tr>
                            ...
                            <th style="width: 15%; white-space: nowrap; text-align: center;"> Address </th>
                            <th style="width: 8%; white-space: nowrap; text-align: center;"> Date to Visit </th>
                            <th style="width: 8%; white-space: nowrap; text-align: center;"> Services to Avail </th>
                            <th style="width: 8%; white-space: nowrap; text-align: center;"> Contact No. </th>
                            <th style="width: 8%; white-space: nowrap; text-align: center;"> Action </th>
                        </tr>
                    </thead>
            ...
            <form id="addPatientForm">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="patientAddress" placeholder="Purok No., House No., Brgy., Municipality, Province" required>
                    </div>
                    <div class="form-group">
                        <label for="patientContact">Contact Number</label>
                        <input type="text" class="form-control" id="patientContact" placeholder="+639________" required>
                    </div>
                    <div class="form-group">
...
<div id="contentModal" style="display: none;">
    <div style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); z-index: 999;">
        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: #fff; padding: 20px; border-radius: 10px; width: 90%; max-width: 500px; max-height: 80%; overflow-y: auto;">
            <div style="background-color: #5D9EFE; color: white; padding: 10px; text-align: center; margin: -20px -20px 20px -20px;">
...
<script>
        ...
        staticData.forEach((data) => {
            const row = `
                <tr>
                    ...
                    <td style="text-align: center;">${data.dateToVisit}</td>
                    <td style="text-align: center;">${data.servicesToAvail}</td>
                    <td style="text-align: center;">${data.contactNo}</td>
                    <td style="text-align: center;">
                        <button class="reservation-btn accept-btn">ACCEPT</button>
                        <button class="reservation-btn cancel-btn"">CANCEL</button>
                    </td>
                </tr>
            `;
            $('#tblreservationlist').append(row);
        });
    }
    ...
    $(document).on('click', '.accept-btn', function() {
        Swal.fire({
            ...
            confirmButtonColor: '#28a745' // Match the accept button color
        });
    });
    ...
    $(document).on('click', '.cancel-btn', function() {
        Swal.fire({
            ...
            icon: 'error',
            confirmButtonText: 'OK',
            confirmButtonColor: '#dc3545' // Match the cancel button color
        });
    });
});
