                ...
                <table data-height="350" class="table fixTable table-hover" style="margin-bottom: 0px; border-bottom: 2px solid #000;">
                    <thead class="bg-success text-white">
                        <tr>
                            ...
                            <th style="width: 8%; white-space: nowrap; text-align: center;"> STATUS </th>
                        </tr>
                    </thead>
        ...
        const staticData = [
            {
                ...
                dateToVisit: '2024-12-02',
                servicesToAvail: 'Prenatal',
            ...
            const row = `
                <tr>
                    ...
                    <td style="text-align: center;">
                        <button class="reservation-btn accept-btn">ACCEPTED</button>
